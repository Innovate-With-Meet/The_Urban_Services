...
export const ProviderLogIn = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("http://localhost:8000/provider/login/", { email, password });
    ...
    const ProviderLogInContainer = styled(Stack)(({ theme }) => ({
        display: "flex",
        justifyContent: "center",
        alignItems: "center",
    ...
    return (
        <div>
            <AppTheme {...props}>
                ...
                <ProviderLogInContainer direction="column" justifyContent="space-between">
